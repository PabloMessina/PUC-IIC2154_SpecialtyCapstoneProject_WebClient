...
const OBJLoader = {
  /**
   * [Parses OBJ file and return a promise tha returns a collection of meshes]
   * @param  {[File]}     objFile   [text file with OBJ format]
   * @param  {[Material]} materials [list of THREE.js materials]
   * @return {[Promise]}            [promise that resolves into a mesh collection]
   */
  loadObjects: (objFile, materials) => {
