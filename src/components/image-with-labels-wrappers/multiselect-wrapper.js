...
export default class ImageWithLabelsMultiSelectWrapper extends Component {
  ...
  /* to update selected answers, is intended to be used by the parent
  component in collaborative evaluations */
  updateSelectedLabels(selectedIds) {
    this.refs.img.updateSelectedLabels(selectedIds);
  }
        ...
        {renderIf(this.props.source)(() => (
          <div>
            <ImageWithLabels
              ...
              labelSelectedCallback={id => console.log('selected id = ', id)}
              labelUnselectedCallback={id => console.log('unselected id = ', id)}
            />
...
ImageWithLabelsMultiSelectWrapper.propTypes = {
